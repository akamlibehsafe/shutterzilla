...
|---|---|
| **[design-system.md](./design-system.md)** | Color palette, typography, spacing, and logo usage guidelines. |
| **[page-inventory.md](./page-inventory.md)** | Complete list of all pages with their file names, purposes, and a sitemap. |
| **[functional-requirements.md](./functional-requirements.md)** | Functional requirements for each section of the platform. |
| **[component-library.md](./component-library.md)** | Reference for reusable UI components (top bar, footer, cards, badges, etc.). |
| **[data-models.md](./data-models.md)** | Suggested data models for the backend (User, CameraListing, etc.). |
...
-   `mockups/images/`: Logo files and placeholder images.
